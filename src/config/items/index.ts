...
export const ITEMS: Item[] = [
  ...
  { id: 'defricheur-fusil-blinf', name: 'Défricheur', category: 'fusils', cult: 'hellvetians', image: IMG + 'rifles/trailblazer_fm.png', caliber: 'Balle Blindée HF', range: '30/120', damage: '11', magazine: '35', properties: 'Régularité (3DC), Rafale (3)', encumbrance: 2, techLevel: 'IV', slots: 2, value: 18000 },
  { id: 'defricheur-fusil-chevrotine', name: 'Défricheur', category: 'fusils', cult: 'hellvetians', image: IMG + 'rifles/trailblazer_buckshot.png', caliber: 'Chevrotine', range: '10/40', damage: '10', magazine: '3', properties: 'Dispersion', encumbrance: 2, techLevel: 'IV', slots: 2, value: 18000 },
  { id: 'defricheur-fusil-creuse', name: 'Défricheur', category: 'fusils', cult: 'hellvetians', image: IMG + 'rifles/trailblazer_hp.png', caliber: 'Pointe Creuse HF', range: '30/120', damage: '14', magazine: '35', properties: 'Régularité (3DC), Rafale (3)', encumbrance: 2, techLevel: 'IV', slots: 2, value: 18000 },
  ...
  { id: 'explosifs', name: 'Explosifs', category: 'explosifs', cult: 'hellvetians', image: IMG + 'grenades/frag_grenade.png', damage: '16', magazine: '1', properties: 'Coup de tonnerre, Explosif', encumbrance: 1, techLevel: 'IV', value: 800, resources: 3 },
  ...
  { id: 'defricheur-blinf', name: 'Défricheur à Canon Scié', category: 'armesDePoing', cult: 'hellvetians', image: IMG + 'handguns/stubbed_trailblazer_fm.png', caliber: 'Balle Blindée HF', range: '15/60', damage: '11', magazine: '20', properties: 'Régularité (2DC)', encumbrance: 2, techLevel: 'V', slots: 2, value: 14000, resources: 4 },
  { id: 'defricheur-creuse', name: 'Défricheur à Canon Scié', category: 'armesDePoing', cult: 'hellvetians', image: IMG + 'handguns/stubbed_trailblazer_hp.png', caliber: 'Pointe Creuse HF', range: '15/60', damage: '14', magazine: '20', properties: 'Régularité (2DC)', encumbrance: 2, techLevel: 'V', slots: 2, value: 14000, resources: 4 },
  ...
  { id: 'mod-circuit-refroidissement', name: 'Circuit de Refroidissement', category: 'modulesHarnaisHellvetiques', cult: 'hellvetians', image: IMG + 'equipment/cooling_aggregate.svg', properties: 'Résiste aux chaleurs extrêmes, 1 Emplacement', techLevel: 'V', value: 5000, resources: 4 },
  { id: 'mod-decoupeur', name: 'Découpeur', category: 'modulesHarnaisHellvetiques', cult: 'hellvetians', image: IMG + 'equipment/cutting_tool.svg', properties: 'Inutile en attaque, 20 points de dégâts par round sur un obstacle, 3 Emplacements', techLevel: 'IV', value: 1200, resources: 2 },
  { id: 'mod-foreur-tunnel', name: 'Foreur à Tunnel', category: 'modulesHarnaisHellvetiques', cult: 'hellvetians', image: IMG + 'equipment/tunnel_driller.svg', properties: 'Béton et roche : 10 points de dégâts par round, réservoir à risque d\'être touché, -6D en combat, 3 Emplacements', techLevel: 'IV', value: 1000, resources: 2 },
  { id: 'mod-poids-lourd', name: 'Poids Lourd', category: 'modulesHarnaisHellvetiques', cult: 'hellvetians', image: IMG + 'equipment/heavyweight.svg', properties: 'PHY+Force : +6D, nécessite 2 Emplacements', techLevel: 'V', value: 6800, resources: 3 },
  { id: 'mod-soudeur-arc', name: 'Soudeur à l\'Arc', category: 'modulesHarnaisHellvetiques', cult: 'hellvetians', image: IMG + 'equipment/arc_welder.svg', properties: '15 points de dégâts sur un obstacle, réservoir à risque d\'être touché, détonation sur au moins 4 dégâts, 3 Emplacements', techLevel: 'IV', value: 2000, resources: 3 },
  ...
  { id: 'scindo', name: 'Scindo', category: 'armesDeLutte', cult: 'romanos', image: IMG + 'brawl/scindo.png', handling: '+1D', damage: '3+F/2', properties: 'Régularité (3DC), Spécial', encumbrance: 1, techLevel: 'II', value: 250, resources: 3 },
