export const clanRanks = {
  ...
  en: {
    ...
    'hunterGatherers-gathererDescription': 'Each season, they know which plants are bearing fruit and how to prepare them. They are also usually responsible for looking after and educating the clan\'s youngest members.<br/><br/><b>REQUIREMENTS:</b> <b>CHA+NEGOTIATION</b> 4 ; <b>CHA+CONDUCT</b> 6 ; <b>INS+ORIENTEERING</b> 6<br/><b>EFFECT:</b> The Gatherer has mastered the territory, its plant resources, and its natural rhythms (<b>+2D</b> for foraging for berries and roots) and knows the right time to trade with traveling merchants. Their diplomatic skills help defuse tensions between neighboring clans.<br/><b>EQUIPMENT:</b> Standard leather maps (<b>+1D</b> to <b>INS+ORIENTEERING</b>)',
