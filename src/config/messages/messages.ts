export const messages = {
  de: {
    ...
    cultRelationships: {
      ...
      readOnlyHelp: 'Diese Beziehungen können in einer geteilten Ansicht nicht bearbeitet werden.',
      reset: 'Beziehungen zurücksetzen',
      resetTitle: 'Kultbeziehungen zurücksetzen?',
      resetConfirmation: 'Alle dreizehn Kultbeziehungen werden auf 0 gesetzt. Diese Aktion kann nicht rückgängig gemacht werden.',
      confirmReset: 'Alle zurücksetzen',
      cardLabel: '{cult}: Beziehung {value}. Mit Enter oder Pfeil nach oben erhöhen; mit Pfeil nach unten verringern.',
    },
    other: {
      title: 'Sonstiges',
      help: 'Narben, Komplikationen, Artefakte und Notizen für den Charakterbogen.',
      scars: 'Narben',
      groupName: 'Gruppenname',
      alignment: 'Ausrichtung',
      constellation: 'Konstellation',
      scarsValue: 'Narbenwert',
      infamy: 'Verruf',
      complications: 'Komplikationen',
      artifacts: 'Artefakte',
      artifactNumber: 'Artefakt {number}',
      artifactName: 'Name',
      activation: 'Aktivierung',
      operation: 'Funktionsweise',
      appraisalValue: 'Schätzwert',
      notes: 'Notizen',
      noteNumber: 'Notiz {number}',
    },
    ...
    expertLCDialog: {
      title: 'Manuelle Drafts/Dinar-Änderung erkannt',
      body: 'Sie haben Ihre Drafts/Dinare im Expertenmodus manuell geändert. Möchten Sie die automatische Berechnung ignorieren und Ihren manuellen Wert behalten?',
    ...
    nameGenerator: {
      ...
      cult: 'Kult',
      clanType: 'Stammestyp',
      generateButton: 'Einen Namen generieren',
      noResult: 'Klicke auf den Button, um einen Namen zu generieren.',
      poolEmpty: 'Alle Namen wurden generiert. Die Liste beginnt von vorne.',
      ...
      cults: {
        ...
        judges: 'Richter',
        clanistes: 'Klanisten',
        scrappers: 'Schrottler',
        neolibyans: 'Neolibyaner',
        scourgers: 'Geißeln',
        anubians: 'Anubianer',
  ...
  en: {
    ...
    cultRelationships: {
      ...
      help: 'Left-click to improve a relationship · Right-click to worsen it',
      readOnlyHelp: 'Relationships cannot be changed while viewing a shared character.',
      reset: 'Reset relationships',
      resetTitle: 'Reset Cult Relationships?',
      resetConfirmation: 'All thirteen Cult relationships will return to 0. This cannot be undone.',
      confirmReset: 'Reset all',
      cardLabel: '{cult}: relationship {value}. Press Enter or Arrow Up to increase; Arrow Down to decrease.',
    },
    other: {
      title: 'Other',
      help: 'Scars, complications, artifacts, and notes for the character sheet.',
      scars: 'Scars',
      groupName: 'Group Name',
      alignment: 'Alignment',
      constellation: 'Constellation',
      scarsValue: 'Scars Value',
      infamy: 'Infamy',
    ...
    expertLCDialog: {
      title: 'Manual Drafts/Dinars change detected',
      body: 'You have manually modified your Drafts/Dinars in Expert mode. Do you want to ignore the automatic calculation and keep your manual value?',
    ...
    nameGenerator: {
      ...
      cult: 'Cult',
      clanType: 'Clan Type',
      generateButton: 'Generate a Name',
      noResult: 'Press the button to generate a name.',
      poolEmpty: 'All names have been generated. The list starts over.',
  ...
  fr: {
    ...
    cultRelationships: {
      title: 'Relations avec les Cultes',
      help: 'Clic gauche : améliorer la relation · Clic droit : détériorer la relation',
      readOnlyHelp: 'Les relations ne peuvent pas être modifiées dans une vue partagée.',
      reset: 'Réinitialiser les relations',
      resetTitle: 'Réinitialiser les relations avec les Cultes ?',
      resetConfirmation: 'Les treize relations avec les Cultes seront remises à 0. Cette action est irréversible.',
      confirmReset: 'Tout réinitialiser',
      cardLabel: '{cult} : relation {value}. Appuyez sur Entrée ou Flèche haut pour augmenter ; Flèche bas pour diminuer.',
    },
    other: {
      title: 'Autre',
      help: 'Cicatrices, complications, artefacts et notes pour la fiche de personnage.',
      scars: 'Cicatrices',
      groupName: 'Nom du groupe',
      alignment: 'Alignement',
      constellation: 'Constellation',
      scarsValue: 'Valeur des cicatrices',
      infamy: 'Infamie',
      complications: 'Complications',
      artifacts: 'Artefacts',
      artifactNumber: 'Artefact {number}',
      artifactName: 'Nom',
      activation: 'Activation',
      operation: 'Fonctionnement',
      appraisalValue: 'Valeur approximative',
      notes: 'Notes',
      noteNumber: 'Note {number}',
    },
    ...
    expertLCDialog: {
      title: 'Modification des Drafts/Dinars détectée',
      body: 'Vous avez modifié vos Drafts/Dinars manuellement en mode Expert. Voulez-vous ignorer le calcul automatique des Drafts/Dinars et conserver votre valeur manuelle ?',
    ...
    nameGenerator: {
      ...
      sex: 'Sexe',
      cult: 'Culte',
      clanType: 'Type de Clan',
      generateButton: 'Générer un Nom',
      noResult: 'Appuyez sur le bouton pour générer un nom.',
      poolEmpty: 'Tous les noms ont été générés. La liste repart du début.',
      ...
      cults: {
        ...
        neolibyans: 'Néolibyens',
        scourgers: 'Fléaux',
        anubians: 'Anubiens',
        jehammedans: 'Jéhammedans',
        apocalyptics: 'Apocalyptiques',
        anabaptists: 'Anabaptistes',
        palers: 'Blafards',
      },
      clanTypes: {
        savage: 'Tribu Sauvage',
